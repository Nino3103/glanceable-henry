...
const AIRecommendations: React.FC = () => {
  ...
  const filteredRecommendations = recommendations.filter((rec) => {
    ...
    const timeframeMatch =
      ...
      rec.timeframe === filters.timeframe;
    const channelMatch =
      filters.channel === Channel.ALL || rec.channel === filters.channel;
    const topicMatch =
      filters.topic === Topic.ALL || rec.topic === filters.topic;
    return (
      urgencyMatch &&
      impactMatch &&
      timeframeMatch &&
